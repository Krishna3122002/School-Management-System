...
import java.awt.event.*;
 class EnterMarks extends JFrame implements ActionListener {
    ...
    EnterMarks() {
        ...
        JLabel lblstd = new JLabel("Select std");
        lblstd.setBounds(50, 110, 150, 20);
        add(lblstd);
        
        String std[] = {"std 1", "std 2", "std 3", "std 4", "std 5", "std 6", "std 7", "std 8" };
        cbstd = new JComboBox(std);
        cbstd.setBounds(200, 110, 150, 20);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit){
            try {
                ...
                String query1 = "insert into subject values('"+crollno.getSelectedItem()+"', '"+cbstd.getSelectedItem()+"', '"+tfsub1.getText()+"', '"+tfsub2.getText()+"', '"+tfsub3.getText()+"', '"+tfsub4.getText()+"', '"+tfsub5.getText()+"')";
                String query2 = "insert into marks values('"+crollno.getSelectedItem()+"', '"+cbstd.getSelectedItem()+"', '"+tfmarks1.getText()+"', '"+tfmarks2.getText()+"', '"+tfmarks3.getText()+"', '"+tfmarks4.getText()+"', '"+tfmarks5.getText()+"')";
